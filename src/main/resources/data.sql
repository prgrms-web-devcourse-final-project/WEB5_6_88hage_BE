...
--        ((SELECT id FROM content_category WHERE category = 'GUKAK'), 'PF269273','RE: TUAL DANCE, 추는 음악',
...
--        ((SELECT id FROM content_category WHERE category = 'CLASSIC'), 'PF269271','차민정 바이올린 독주회', '만 7세 이상',
...
--        ((SELECT id FROM content_category WHERE category = 'THEATER'), 'PF269269','제28회 서울프린지페스티벌, 공과사',
...
--        ((SELECT id FROM content_category WHERE category = 'CLASSIC'),
--         'PF269267', '소프라노 한보경 독창회: Die Liebe ist...','만 7세 이상', '전석 30,000원', '2025-07-29', '2025-07-29',
...
--        ((SELECT id FROM content_category WHERE category = 'POP_MUSIC'), 'PF269265','홍경민 매달리스트 콘서트', '만 7세 이상',
...
--        ((SELECT id FROM content_category WHERE category = 'THEATER'), 'PF269261','브릴리언트: 찬란하게 빛나던 [대학로]',
...
--        ((SELECT id FROM content_category WHERE category = 'CLASSIC'), 'PF269258','안종도 피아노 리사이틀', '만 7세 이상',
...
--        ((SELECT id FROM content_category WHERE category = 'POP_MUSIC'), 'PF269257','Flight: 원위 (ONEWE) 편 [서울]',
...
--         'PF269249', 'Kep1er CONCERT TOUR, Into The Orbit: Kep1asia [서울]', '만 7세 이상',
...
--         'PF269246','언더노트 Vol.4, 조하린 서현석의 뮤지컬 갈라 콘서트: 어쩌다 보니', '만 12세 이상', '전석 40,000원', '2025-08-02',
...
--        ((SELECT id FROM content_category WHERE category = 'POP_MUSIC'),
--         'PF269236','전자양, 소음의 왕 10주년 기념 단독공연: 우리가 이겼어!', '만 19세 이상', '스탠딩 55,000원', '2025-08-09', '2025-08-10',
